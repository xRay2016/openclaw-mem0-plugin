...
export const buildConfig = (pluginConfig) => {
    return {
        ...
        baseUrl: pluginConfig?.baseUrl || process.env.MEM0_BASE_URL || 'https://api.mem0.ai/v1',
    };
};
...
class Mem0Client {
   ...
   */
    async search(query, options = {}) {
        ...
        return this._request('/memories/search/', 'POST', payload);
    }
    ...
    async add(messages, options = {}) {
        ...
        return this._request('/memories/', 'POST', payload);
    }
}
